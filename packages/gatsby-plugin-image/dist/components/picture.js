...
exports.Picture = react_1.forwardRef(function Picture(_a, ref) {
    var fallback = _a.fallback, _b = _a.sources, sources = _b === void 0 ? [] : _b, _c = _a.shouldLoad, shouldLoad = _c === void 0 ? true : _c, sizes = _a.sizes, props = __rest(_a, ["fallback", "sources", "shouldLoad", "sizes"]);
    var fallbackImage = (react_1["default"].createElement(Image, __assign({ sizes: sizes }, props, fallback, { shouldLoad: shouldLoad, innerRef: ref })));
    if (!sources.length) {
